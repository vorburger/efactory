 ...
 * </copyright>
 *
 * $Id: TestmodelAdapterFactory.java 82 2009-11-16 05:39:21Z sebastian.benz $
 */
...
public class TestmodelAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link testmodel.Child
	 * <em>Child</em>}'. <!-- begin-user-doc --> This default implementation
	 ...
	 * {@link testmodel.SingleOptional <em>Single Optional</em>}'. <!--
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link testmodel.SingleRequired <em>Single Required</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we
	 * can easily ignore cases; it's useful to ignore a case when inheritance
	 * will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class '{@link testmodel.Interface
	...
	/**
	 * Creates a new adapter for an object of class '{@link testmodel.Abstract
	 * <em>Abstract</em>}'. <!-- begin-user-doc --> This default implementation
	 * returns null so that we can easily ignore cases; it's useful to ignore a
	 * case when inheritance will catch all the cases anyway. <!-- end-user-doc
	 * -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link testmodel.NestedElements <em>Nested Elements</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we
	 * can easily ignore cases; it's useful to ignore a case when inheritance
	 * will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link testmodel.NestedElement <em>Nested Element</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we
	 * can easily ignore cases; it's useful to ignore a case when inheritance
	 * will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link testmodel.AttributeSample <em>Attribute Sample</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we
	 * can easily ignore cases; it's useful to ignore a case when inheritance
	 * will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link testmodel.ReferenceTarget <em>Reference Target</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we
	 * can easily ignore cases; it's useful to ignore a case when inheritance
	 * will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class '{@link testmodel.NoName
	 * <em>No Name</em>}'. <!-- begin-user-doc --> This default implementation
	 * returns null so that we can easily ignore cases; it's useful to ignore a
	 * case when inheritance will catch all the cases anyway. <!-- end-user-doc
	 * -->
	 * 
