 ...
 * </copyright>
 *
 * $Id: TestmodelPackageImpl.java 82 2009-11-16 05:39:21Z sebastian.benz $
 */
...
public class TestmodelPackageImpl extends EPackageImpl implements
	...
	public EReference getSingleRequired_NestedElements() {
		return (EReference) singleRequiredEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public EAttribute getSingleRequired_Name() {
		return (EAttribute) singleRequiredEClass.getEStructuralFeatures()
				.get(2);
	}
	...
	public EAttribute getAttributeSample_SingleIntOptional() {
		return (EAttribute) attributeSampleEClass.getEStructuralFeatures().get(
				0);
	}
	...
	public EReference getReferenceTestContainer_Containments() {
		return (EReference) referenceTestContainerEClass
	...
	public EAttribute getReferenceTestContainer_Name() {
		return (EAttribute) referenceTestContainerEClass
	...
	public EAttribute getReferenceTarget_Name() {
		return (EAttribute) referenceTargetEClass.getEStructuralFeatures().get(
				0);
	}
	...
	public EAttribute getAttributeTestContainer_Name() {
		return (EAttribute) attributeTestContainerEClass
				.getEStructuralFeatures().get(0);
	}
	...
	public EReference getNameAttributeContainer_DefaultNameTest() {
		return (EReference) nameAttributeContainerEClass
				.getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getNameAttributeContainer_Name() {
		return (EAttribute) nameAttributeContainerEClass
				.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(attributeSampleEClass,
				ATTRIBUTE_SAMPLE__SINGLE_INT_OPTIONAL);
		createEAttribute(attributeSampleEClass,
				ATTRIBUTE_SAMPLE__LIST_INT_REQUIRED);
		...
		createEReference(referenceTestContainerEClass,
				REFERENCE_TEST_CONTAINER__CONTAINMENTS);
		createEReference(referenceTestContainerEClass,
				REFERENCE_TEST_CONTAINER__REFERENCE_TO_ONE);
		createEReference(referenceTestContainerEClass,
				REFERENCE_TEST_CONTAINER__REFERENCE_TO_MANY);
		createEAttribute(referenceTestContainerEClass,
				REFERENCE_TEST_CONTAINER__NAME);
		createEReference(referenceTestContainerEClass,
				REFERENCE_TEST_CONTAINER__CONTAINMENT);
		createEAttribute(referenceTestContainerEClass,
				REFERENCE_TEST_CONTAINER__ONE_ATTRIBUTE);
		createEAttribute(referenceTestContainerEClass,
				REFERENCE_TEST_CONTAINER__MANY_ATTRIBUTES);
		...
		createEAttribute(attributeTestContainerEClass,
				ATTRIBUTE_TEST_CONTAINER__NAME);
		createEAttribute(attributeTestContainerEClass,
				ATTRIBUTE_TEST_CONTAINER__ONE_INT);
		createEAttribute(attributeTestContainerEClass,
				ATTRIBUTE_TEST_CONTAINER__MANY_INT);
		createEAttribute(attributeTestContainerEClass,
				ATTRIBUTE_TEST_CONTAINER__ONE_BOOL);
		createEAttribute(attributeTestContainerEClass,
				ATTRIBUTE_TEST_CONTAINER__MANY_BOOL);
		createEAttribute(attributeTestContainerEClass,
				ATTRIBUTE_TEST_CONTAINER__ONE_DOUBLE);
		createEAttribute(attributeTestContainerEClass,
				ATTRIBUTE_TEST_CONTAINER__MANY_DOUBLE);
		createEAttribute(attributeTestContainerEClass,
				ATTRIBUTE_TEST_CONTAINER__ONE_BIG_DECIMAL);
		createEAttribute(attributeTestContainerEClass,
				ATTRIBUTE_TEST_CONTAINER__MANY_BIG_DECIMAL);
		createEAttribute(attributeTestContainerEClass,
				ATTRIBUTE_TEST_CONTAINER__ONE_BIG_INTEGER);
		createEAttribute(attributeTestContainerEClass,
				ATTRIBUTE_TEST_CONTAINER__MANY_BIG_INTEGER);
		createEAttribute(attributeTestContainerEClass,
				ATTRIBUTE_TEST_CONTAINER__ONE_ENUM);
		createEAttribute(attributeTestContainerEClass,
				ATTRIBUTE_TEST_CONTAINER__MANY_ENUMS);
		createEAttribute(attributeTestContainerEClass,
				ATTRIBUTE_TEST_CONTAINER__ONE_SHORT);
		createEAttribute(attributeTestContainerEClass,
				ATTRIBUTE_TEST_CONTAINER__MANY_SHORTS);
		createEAttribute(attributeTestContainerEClass,
				ATTRIBUTE_TEST_CONTAINER__ONE_DATE);
		createEAttribute(attributeTestContainerEClass,
				ATTRIBUTE_TEST_CONTAINER__MANY_DATES);
		createEAttribute(attributeTestContainerEClass,
				ATTRIBUTE_TEST_CONTAINER__ONE_STRING);
		createEAttribute(attributeTestContainerEClass,
				ATTRIBUTE_TEST_CONTAINER__MANY_STRING);

		nameAttributeContainerEClass = createEClass(NAME_ATTRIBUTE_CONTAINER);
		createEReference(nameAttributeContainerEClass,
				NAME_ATTRIBUTE_CONTAINER__DEFAULT_NAME_TEST);
		createEReference(nameAttributeContainerEClass,
				NAME_ATTRIBUTE_CONTAINER__CUSTOM_NAME_TEST);
		createEAttribute(nameAttributeContainerEClass,
				NAME_ATTRIBUTE_CONTAINER__NAME);
		createEReference(nameAttributeContainerEClass,
				NAME_ATTRIBUTE_CONTAINER__NO_NAME_TEST);
	...
	public void initializePackageContents() {
		...
		referenceTargetSubclassEClass.getESuperTypes().add(
				this.getReferenceTarget());

		// Initialize classes and features; add operations and parameters
		initEClass(testModelEClass, TestModel.class, "TestModel", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTestModel_Children(), this.getChild(), null,
				"children", null, 0, -1, TestModel.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTestModel_SingleOptional(), this.getSingleOptional(),
				null, "singleOptional", null, 0, 1, TestModel.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getTestModel_SingleRequired(), this.getSingleRequired(),
				null, "singleRequired", null, 1, 1, TestModel.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getTestModel_Name(), ecorePackage.getEString(), "name",
				null, 0, 1, TestModel.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getTestModel_AttributeSample(), this
				.getAttributeSample(), null, "attributeSample", null, 0, 1,
				TestModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getTestModel_LinkToSingleRequired(), this
				.getSingleRequired(), null, "linkToSingleRequired", null, 0, 1,
				TestModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getTestModel_ReferenceTestContainer(), this
				.getReferenceTestContainer(), null, "referenceTestContainer",
				null, 0, -1, TestModel.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTestModel_AttributeTest(), this
				.getAttributeTestContainer(), null, "attributeTest", null, 0,
				-1, TestModel.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTestModel_NameAttributeTest(), this
				.getNameAttributeContainer(), null, "nameAttributeTest", null,
				0, -1, TestModel.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(childEClass, Child.class, "Child", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getChild_ReferenceList(), this.getSingleRequired(),
				null, "referenceList", null, 0, -1, Child.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(singleOptionalEClass, SingleOptional.class,
				"SingleOptional", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(singleRequiredEClass, SingleRequired.class,
				"SingleRequired", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSingleRequired_NestedElements(), this
				.getNestedElements(), null, "nestedElements", null, 0, -1,
				SingleRequired.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSingleRequired_NestedElement(), this
				.getNestedElement(), null, "nestedElement", null, 0, 1,
				SingleRequired.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSingleRequired_Name(), ecorePackage.getEString(),
				"name", null, 0, 1, SingleRequired.class, !IS_TRANSIENT,
		...
		initEClass(abstractEClass, Abstract.class, "Abstract", IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getAbstract_ParentAttribute(), ecorePackage
				.getEBoolean(), "parentAttribute", null, 0, 1, Abstract.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAbstract_ParentReference(), this.getTestModel(),
				null, "parentReference", null, 0, 1, Abstract.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getAbstract_ParentContainment(), this.getInterface(),
				null, "parentContainment", null, 0, 1, Abstract.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		initEClass(nestedElementsEClass, NestedElements.class,
				"NestedElements", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(nestedElementEClass, NestedElement.class, "NestedElement",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getNestedElement_Id(), ecorePackage.getEString(), "id",
				null, 0, 1, NestedElement.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		initEClass(attributeSampleEClass, AttributeSample.class,
				"AttributeSample", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getAttributeSample_SingleIntOptional(), ecorePackage
				.getEInt(), "singleIntOptional", null, 0, 1,
				AttributeSample.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getAttributeSample_ListIntRequired(), ecorePackage
				.getEInt(), "listIntRequired", null, 1, -1,
				AttributeSample.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getAttributeSample_BigDecimal(), ecorePackage
				.getEBigDecimal(), "bigDecimal", null, 0, 1,
				AttributeSample.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getAttributeSample_BigInteger(), ecorePackage
				.getEBigInteger(), "bigInteger", null, 0, 1,
				AttributeSample.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getAttributeSample_Double(), ecorePackage.getEDouble(),
				"double", null, 0, 1, AttributeSample.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(referenceTestContainerEClass, ReferenceTestContainer.class,
				"ReferenceTestContainer", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getReferenceTestContainer_Containments(), this
				.getReferenceTarget(), null, "containments", null, 0, -1,
				ReferenceTestContainer.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getReferenceTestContainer_ReferenceToOne(), this
				.getReferenceTarget(), null, "referenceToOne", null, 0, 1,
				ReferenceTestContainer.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getReferenceTestContainer_ReferenceToMany(), this
				.getReferenceTarget(), null, "referenceToMany", null, 0, -1,
				ReferenceTestContainer.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getReferenceTestContainer_Name(), ecorePackage
				.getEString(), "name", null, 0, 1,
				ReferenceTestContainer.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getReferenceTestContainer_Containment(), this
				.getReferenceTarget(), null, "containment", null, 0, 1,
				ReferenceTestContainer.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getReferenceTestContainer_OneAttribute(), ecorePackage
				.getEBoolean(), "oneAttribute", null, 0, 1,
				ReferenceTestContainer.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getReferenceTestContainer_ManyAttributes(), ecorePackage
				.getEBoolean(), "manyAttributes", null, 0, -1,
				ReferenceTestContainer.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		initEClass(referenceTargetEClass, ReferenceTarget.class,
				"ReferenceTarget", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getReferenceTarget_Name(), ecorePackage.getEString(),
				"name", null, 0, 1, ReferenceTarget.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(referenceTargetSubclassEClass,
				ReferenceTargetSubclass.class, "ReferenceTargetSubclass",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(attributeTestContainerEClass, AttributeTestContainer.class,
				"AttributeTestContainer", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getAttributeTestContainer_Name(), ecorePackage
				.getEString(), "name", null, 0, 1,
				AttributeTestContainer.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getAttributeTestContainer_OneInt(), ecorePackage
				.getEInt(), "oneInt", null, 0, 1, AttributeTestContainer.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAttributeTestContainer_ManyInt(), ecorePackage
				.getEInt(), "manyInt", null, 0, -1,
				AttributeTestContainer.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getAttributeTestContainer_OneBool(), ecorePackage
				.getEBoolean(), "oneBool", null, 0, 1,
				AttributeTestContainer.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getAttributeTestContainer_ManyBool(), ecorePackage
				.getEBoolean(), "manyBool", null, 0, -1,
				AttributeTestContainer.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getAttributeTestContainer_OneDouble(), ecorePackage
				.getEDouble(), "oneDouble", null, 0, 1,
				AttributeTestContainer.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getAttributeTestContainer_ManyDouble(), ecorePackage
				.getEDouble(), "manyDouble", null, 0, -1,
				AttributeTestContainer.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getAttributeTestContainer_OneBigDecimal(), ecorePackage
				.getEBigDecimal(), "oneBigDecimal", null, 0, 1,
				AttributeTestContainer.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getAttributeTestContainer_ManyBigDecimal(), ecorePackage
				.getEBigDecimal(), "manyBigDecimal", null, 0, -1,
				AttributeTestContainer.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getAttributeTestContainer_OneBigInteger(), ecorePackage
				.getEBigInteger(), "oneBigInteger", null, 0, 1,
				AttributeTestContainer.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getAttributeTestContainer_ManyBigInteger(), ecorePackage
				.getEBigInteger(), "manyBigInteger", null, 0, -1,
				AttributeTestContainer.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getAttributeTestContainer_OneEnum(), this
				.getSampleEnum(), "oneEnum", null, 0, 1,
				AttributeTestContainer.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getAttributeTestContainer_ManyEnums(), this
				.getSampleEnum(), "manyEnums", null, 0, -1,
				AttributeTestContainer.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getAttributeTestContainer_OneShort(), ecorePackage
				.getEShort(), "oneShort", null, 0, 1,
				AttributeTestContainer.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getAttributeTestContainer_ManyShorts(), ecorePackage
				.getEShort(), "manyShorts", null, 0, -1,
				AttributeTestContainer.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getAttributeTestContainer_OneDate(), ecorePackage
				.getEDate(), "oneDate", null, 0, 1,
				AttributeTestContainer.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getAttributeTestContainer_ManyDates(), ecorePackage
				.getEDate(), "manyDates", null, 0, -1,
				AttributeTestContainer.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getAttributeTestContainer_OneString(), ecorePackage
				.getEString(), "oneString", null, 0, 1,
				AttributeTestContainer.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getAttributeTestContainer_ManyString(), ecorePackage
				.getEString(), "manyString", null, 0, -1,
				AttributeTestContainer.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		initEClass(nameAttributeContainerEClass, NameAttributeContainer.class,
				"NameAttributeContainer", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getNameAttributeContainer_DefaultNameTest(), this
				.getDefaultName(), null, "defaultNameTest", null, 0, 1,
				NameAttributeContainer.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getNameAttributeContainer_CustomNameTest(), this
				.getCustomName(), null, "customNameTest", null, 0, 1,
				NameAttributeContainer.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getNameAttributeContainer_Name(), ecorePackage
				.getEString(), "name", null, 0, 1,
				NameAttributeContainer.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getNameAttributeContainer_NoNameTest(),
				this.getNoName(), null, "noNameTest", null, 0, 1,
				NameAttributeContainer.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(defaultNameEClass, DefaultName.class, "DefaultName",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getDefaultName_Name(), ecorePackage.getEString(),
				"name", null, 0, 1, DefaultName.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(customNameEClass, CustomName.class, "CustomName",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCustomName_Id(), ecorePackage.getEString(), "id",
				null, 0, 1, CustomName.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		initEClass(noNameEClass, NoName.class, "NoName", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
