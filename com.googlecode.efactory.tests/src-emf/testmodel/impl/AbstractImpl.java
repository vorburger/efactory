 ...
 * </copyright>
 *
 * $Id: AbstractImpl.java 82 2009-11-16 05:39:21Z sebastian.benz $
 */
 ...
 * <ul>
 * <li>{@link testmodel.impl.AbstractImpl#isParentAttribute <em>Parent Attribute
 * </em>}</li>
 * <li>{@link testmodel.impl.AbstractImpl#getParentReference <em>Parent
 * Reference</em>}</li>
 * <li>{@link testmodel.impl.AbstractImpl#getParentContainment <em>Parent
 * Containment</em>}</li>
 * </ul>
 * </p>
 * 
...
public abstract class AbstractImpl extends EObjectImpl implements Abstract {
	/**
	 * The default value of the '{@link #isParentAttribute()
	...
	/**
	 * The cached value of the '{@link #isParentAttribute()
	 * <em>Parent Attribute</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #isParentAttribute()
	...
	/**
	 * The cached value of the '{@link #getParentReference()
	...
	/**
	 * The cached value of the '{@link #getParentContainment()
	...
	public void setParentAttribute(boolean newParentAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TestmodelPackage.ABSTRACT__PARENT_ATTRIBUTE,
			...
			if (parentReference != oldParentReference) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							TestmodelPackage.ABSTRACT__PARENT_REFERENCE,
	...
	public Interface getParentContainment() {
		if (parentContainment != null && parentContainment.eIsProxy()) {
			...
			if (parentContainment != oldParentContainment) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							TestmodelPackage.ABSTRACT__PARENT_CONTAINMENT,
							oldParentContainment, parentContainment));
			}
		}
