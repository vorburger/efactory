 ...
 * </copyright>
 *
 * $Id: AttributeSampleImpl.java 82 2009-11-16 05:39:21Z sebastian.benz $
 */
 ...
 * <ul>
 * <li>{@link testmodel.impl.AttributeSampleImpl#getSingleIntOptional <em>Single
 * Int Optional</em>}</li>
 * <li>{@link testmodel.impl.AttributeSampleImpl#getListIntRequired <em>List Int
 * Required</em>}</li>
 * <li>{@link testmodel.impl.AttributeSampleImpl#getBigDecimal <em>Big Decimal
 * </em>}</li>
 * <li>{@link testmodel.impl.AttributeSampleImpl#getBigInteger <em>Big Integer
 * </em>}</li>
...
public class AttributeSampleImpl extends EObjectImpl implements AttributeSample {
	/**
	 * The default value of the '{@link #getSingleIntOptional()
	...
	/**
	 * The cached value of the '{@link #getSingleIntOptional()
	 * <em>Single Int Optional</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getSingleIntOptional()
	...
	/**
	 * The cached value of the '{@link #getListIntRequired()
	 * <em>List Int Required</em>}' attribute list. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * The default value of the '{@link #getBigDecimal() <em>Big Decimal</em>}'
	...
	/**
	 * The cached value of the '{@link #getBigDecimal() <em>Big Decimal</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getBigDecimal()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getBigInteger() <em>Big Integer</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getBigInteger()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getBigInteger() <em>Big Integer</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getBigInteger()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getDouble() <em>Double</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getDouble()
	 * @generated
	...
	public void setSingleIntOptional(int newSingleIntOptional) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TestmodelPackage.ATTRIBUTE_SAMPLE__SINGLE_INT_OPTIONAL,
					oldSingleIntOptional, singleIntOptional));
	}
	...
	public EList<Integer> getListIntRequired() {
		if (listIntRequired == null) {
			listIntRequired = new EDataTypeUniqueEList<Integer>(Integer.class,
					this, TestmodelPackage.ATTRIBUTE_SAMPLE__LIST_INT_REQUIRED);
		}
	...
	public void setBigDecimal(BigDecimal newBigDecimal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TestmodelPackage.ATTRIBUTE_SAMPLE__BIG_DECIMAL,
	...
	public void setBigInteger(BigInteger newBigInteger) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TestmodelPackage.ATTRIBUTE_SAMPLE__BIG_INTEGER,
	...
	public void setDouble(double newDouble) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TestmodelPackage.ATTRIBUTE_SAMPLE__DOUBLE, oldDouble,
					double_));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case TestmodelPackage.ATTRIBUTE_SAMPLE__BIG_DECIMAL:
			return BIG_DECIMAL_EDEFAULT == null ? bigDecimal != null
					: !BIG_DECIMAL_EDEFAULT.equals(bigDecimal);
		case TestmodelPackage.ATTRIBUTE_SAMPLE__BIG_INTEGER:
			return BIG_INTEGER_EDEFAULT == null ? bigInteger != null
					: !BIG_INTEGER_EDEFAULT.equals(bigInteger);
		case TestmodelPackage.ATTRIBUTE_SAMPLE__DOUBLE:
