 ...
 * </copyright>
 *
 * $Id: AttributeTestContainerImpl.java 82 2009-11-16 05:39:21Z sebastian.benz $
 */
 ...
 * <li>{@link testmodel.impl.AttributeTestContainerImpl#getOneInt <em>One Int
 * </em>}</li>
 * <li>{@link testmodel.impl.AttributeTestContainerImpl#getManyInt <em>Many Int
 * </em>}</li>
 * <li>{@link testmodel.impl.AttributeTestContainerImpl#isOneBool <em>One Bool
 * </em>}</li>
 * <li>{@link testmodel.impl.AttributeTestContainerImpl#getManyBool <em>Many
 * Bool</em>}</li>
 * <li>{@link testmodel.impl.AttributeTestContainerImpl#getOneDouble <em>One
 * Double</em>}</li>
 * <li>{@link testmodel.impl.AttributeTestContainerImpl#getManyDouble <em>Many
 * Double</em>}</li>
 * <li>{@link testmodel.impl.AttributeTestContainerImpl#getOneBigDecimal <em>One
 * Big Decimal</em>}</li>
 * <li>{@link testmodel.impl.AttributeTestContainerImpl#getManyBigDecimal <em>
 * Many Big Decimal</em>}</li>
 * <li>{@link testmodel.impl.AttributeTestContainerImpl#getOneBigInteger <em>One
 * Big Integer</em>}</li>
 * <li>{@link testmodel.impl.AttributeTestContainerImpl#getManyBigInteger <em>
 * Many Big Integer</em>}</li>
 * <li>{@link testmodel.impl.AttributeTestContainerImpl#getOneEnum <em>One Enum
 * </em>}</li>
 * <li>{@link testmodel.impl.AttributeTestContainerImpl#getManyEnums <em>Many
 * Enums</em>}</li>
 * <li>{@link testmodel.impl.AttributeTestContainerImpl#getOneShort <em>One
 * Short</em>}</li>
 * <li>{@link testmodel.impl.AttributeTestContainerImpl#getManyShorts <em>Many
 * Shorts</em>}</li>
 * <li>{@link testmodel.impl.AttributeTestContainerImpl#getOneDate <em>One Date
 * </em>}</li>
 * <li>{@link testmodel.impl.AttributeTestContainerImpl#getManyDates <em>Many
 * Dates</em>}</li>
 * <li>{@link testmodel.impl.AttributeTestContainerImpl#getOneString <em>One
 * String</em>}</li>
 * <li>{@link testmodel.impl.AttributeTestContainerImpl#getManyString <em>Many
 * String</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
 */
public class AttributeTestContainerImpl extends EObjectImpl implements
	...
	/**
	 * The default value of the '{@link #getOneInt() <em>One Int</em>}'
	...
	/**
	 * The cached value of the '{@link #getOneInt() <em>One Int</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getOneInt()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getManyInt() <em>Many Int</em>}'
	...
	/**
	 * The default value of the '{@link #isOneBool() <em>One Bool</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isOneBool()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #isOneBool() <em>One Bool</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isOneBool()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getManyBool() <em>Many Bool</em>}'
	 * attribute list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getManyBool()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getOneDouble() <em>One Double</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getOneDouble()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getOneDouble() <em>One Double</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getOneDouble()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getManyDouble() <em>Many Double</em>}'
	 * attribute list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getManyDouble()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getOneBigDecimal()
	...
	/**
	 * The cached value of the '{@link #getOneBigDecimal()
	 * <em>One Big Decimal</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getOneBigDecimal()
	...
	/**
	 * The cached value of the '{@link #getManyBigDecimal()
	 * <em>Many Big Decimal</em>}' attribute list. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * The default value of the '{@link #getOneBigInteger()
	...
	/**
	 * The cached value of the '{@link #getOneBigInteger()
	 * <em>One Big Integer</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getOneBigInteger()
	...
	/**
	 * The cached value of the '{@link #getManyBigInteger()
	 * <em>Many Big Integer</em>}' attribute list. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * The default value of the '{@link #getOneEnum() <em>One Enum</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getOneEnum()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getOneEnum() <em>One Enum</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getOneEnum()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getManyEnums() <em>Many Enums</em>}'
	 * attribute list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getManyEnums()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getOneShort() <em>One Short</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getOneShort()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getOneShort() <em>One Short</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getOneShort()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getManyShorts() <em>Many Shorts</em>}'
	 * attribute list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getManyShorts()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getOneDate() <em>One Date</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getOneDate()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getOneDate() <em>One Date</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getOneDate()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getManyDates() <em>Many Dates</em>}'
	 * attribute list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getManyDates()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getOneString() <em>One String</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getOneString()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getOneString() <em>One String</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getOneString()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getManyString() <em>Many String</em>}'
	 * attribute list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getManyString()
	 * @generated
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TestmodelPackage.ATTRIBUTE_TEST_CONTAINER__NAME, oldName,
					name));
	}
	...
	public void setOneInt(int newOneInt) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TestmodelPackage.ATTRIBUTE_TEST_CONTAINER__ONE_INT,
					oldOneInt, oneInt));
	}
	...
	public EList<Integer> getManyInt() {
		if (manyInt == null) {
			manyInt = new EDataTypeUniqueEList<Integer>(Integer.class, this,
					TestmodelPackage.ATTRIBUTE_TEST_CONTAINER__MANY_INT);
		}
		return manyInt;
	}
	...
	public void setOneBool(boolean newOneBool) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TestmodelPackage.ATTRIBUTE_TEST_CONTAINER__ONE_BOOL,
					oldOneBool, oneBool));
	}
	...
	public EList<Boolean> getManyBool() {
		if (manyBool == null) {
			manyBool = new EDataTypeEList<Boolean>(Boolean.class, this,
					TestmodelPackage.ATTRIBUTE_TEST_CONTAINER__MANY_BOOL);
		}
		return manyBool;
	}
	...
	public void setOneDouble(double newOneDouble) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TestmodelPackage.ATTRIBUTE_TEST_CONTAINER__ONE_DOUBLE,
					oldOneDouble, oneDouble));
	}
	...
	public EList<Double> getManyDouble() {
		if (manyDouble == null) {
			manyDouble = new EDataTypeUniqueEList<Double>(Double.class, this,
					TestmodelPackage.ATTRIBUTE_TEST_CONTAINER__MANY_DOUBLE);
		}
		return manyDouble;
	}
	...
	public void setOneBigDecimal(BigDecimal newOneBigDecimal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TestmodelPackage.ATTRIBUTE_TEST_CONTAINER__ONE_BIG_DECIMAL,
					oldOneBigDecimal, oneBigDecimal));
	}
	...
	public EList<BigDecimal> getManyBigDecimal() {
		if (manyBigDecimal == null) {
			manyBigDecimal = new EDataTypeUniqueEList<BigDecimal>(
					BigDecimal.class, this,
					TestmodelPackage.ATTRIBUTE_TEST_CONTAINER__MANY_BIG_DECIMAL);
		}
	...
	public void setOneBigInteger(BigInteger newOneBigInteger) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TestmodelPackage.ATTRIBUTE_TEST_CONTAINER__ONE_BIG_INTEGER,
					oldOneBigInteger, oneBigInteger));
	}
	...
	public EList<BigInteger> getManyBigInteger() {
		if (manyBigInteger == null) {
			manyBigInteger = new EDataTypeUniqueEList<BigInteger>(
					BigInteger.class, this,
					TestmodelPackage.ATTRIBUTE_TEST_CONTAINER__MANY_BIG_INTEGER);
		}
	...
	public void setOneEnum(SampleEnum newOneEnum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TestmodelPackage.ATTRIBUTE_TEST_CONTAINER__ONE_ENUM,
					oldOneEnum, oneEnum));
	}
	...
	public EList<SampleEnum> getManyEnums() {
		if (manyEnums == null) {
			manyEnums = new EDataTypeUniqueEList<SampleEnum>(SampleEnum.class,
					this, TestmodelPackage.ATTRIBUTE_TEST_CONTAINER__MANY_ENUMS);
		}
		return manyEnums;
	}
	...
	public void setOneShort(short newOneShort) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TestmodelPackage.ATTRIBUTE_TEST_CONTAINER__ONE_SHORT,
					oldOneShort, oneShort));
	}
	...
	public EList<Short> getManyShorts() {
		if (manyShorts == null) {
			manyShorts = new EDataTypeUniqueEList<Short>(Short.class, this,
					TestmodelPackage.ATTRIBUTE_TEST_CONTAINER__MANY_SHORTS);
		}
		return manyShorts;
	}
	...
	public void setOneDate(Date newOneDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TestmodelPackage.ATTRIBUTE_TEST_CONTAINER__ONE_DATE,
					oldOneDate, oneDate));
	}
	...
	public EList<Date> getManyDates() {
		if (manyDates == null) {
			manyDates = new EDataTypeUniqueEList<Date>(Date.class, this,
					TestmodelPackage.ATTRIBUTE_TEST_CONTAINER__MANY_DATES);
		}
		return manyDates;
	}
	...
	public void setOneString(String newOneString) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TestmodelPackage.ATTRIBUTE_TEST_CONTAINER__ONE_STRING,
					oldOneString, oneString));
	}
	...
	public EList<String> getManyString() {
		if (manyString == null) {
			manyString = new EDataTypeUniqueEList<String>(String.class, this,
					TestmodelPackage.ATTRIBUTE_TEST_CONTAINER__MANY_STRING);
		}
		return manyString;
	}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case TestmodelPackage.ATTRIBUTE_TEST_CONTAINER__MANY_BIG_DECIMAL:
			...
			getManyBigDecimal().addAll(
					(Collection<? extends BigDecimal>) newValue);
			return;
		case TestmodelPackage.ATTRIBUTE_TEST_CONTAINER__ONE_BIG_INTEGER:
		...
		case TestmodelPackage.ATTRIBUTE_TEST_CONTAINER__MANY_BIG_INTEGER:
			...
			getManyBigInteger().addAll(
					(Collection<? extends BigInteger>) newValue);
			return;
		case TestmodelPackage.ATTRIBUTE_TEST_CONTAINER__ONE_ENUM:
	...
	public boolean eIsSet(int featureID) {
		...
		case TestmodelPackage.ATTRIBUTE_TEST_CONTAINER__ONE_BIG_DECIMAL:
			return ONE_BIG_DECIMAL_EDEFAULT == null ? oneBigDecimal != null
					: !ONE_BIG_DECIMAL_EDEFAULT.equals(oneBigDecimal);
		case TestmodelPackage.ATTRIBUTE_TEST_CONTAINER__MANY_BIG_DECIMAL:
			return manyBigDecimal != null && !manyBigDecimal.isEmpty();
		case TestmodelPackage.ATTRIBUTE_TEST_CONTAINER__ONE_BIG_INTEGER:
			return ONE_BIG_INTEGER_EDEFAULT == null ? oneBigInteger != null
					: !ONE_BIG_INTEGER_EDEFAULT.equals(oneBigInteger);
		case TestmodelPackage.ATTRIBUTE_TEST_CONTAINER__MANY_BIG_INTEGER:
		...
		case TestmodelPackage.ATTRIBUTE_TEST_CONTAINER__ONE_DATE:
			return ONE_DATE_EDEFAULT == null ? oneDate != null
					: !ONE_DATE_EDEFAULT.equals(oneDate);
		case TestmodelPackage.ATTRIBUTE_TEST_CONTAINER__MANY_DATES:
			return manyDates != null && !manyDates.isEmpty();
		case TestmodelPackage.ATTRIBUTE_TEST_CONTAINER__ONE_STRING:
			return ONE_STRING_EDEFAULT == null ? oneString != null
					: !ONE_STRING_EDEFAULT.equals(oneString);
		case TestmodelPackage.ATTRIBUTE_TEST_CONTAINER__MANY_STRING:
