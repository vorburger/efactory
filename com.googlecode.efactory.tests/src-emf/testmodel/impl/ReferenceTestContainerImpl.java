 ...
 * </copyright>
 *
 * $Id: ReferenceTestContainerImpl.java 82 2009-11-16 05:39:21Z sebastian.benz $
 */
 ...
 * <ul>
 * <li>{@link testmodel.impl.ReferenceTestContainerImpl#getContainments <em>
 * Containments</em>}</li>
 * <li>{@link testmodel.impl.ReferenceTestContainerImpl#getReferenceToOne <em>
 * Reference To One</em>}</li>
 * <li>{@link testmodel.impl.ReferenceTestContainerImpl#getReferenceToMany <em>
 * Reference To Many</em>}</li>
 * <li>{@link testmodel.impl.ReferenceTestContainerImpl#getName <em>Name</em>}</li>
 * <li>{@link testmodel.impl.ReferenceTestContainerImpl#getContainment <em>
 * Containment</em>}</li>
 * <li>{@link testmodel.impl.ReferenceTestContainerImpl#isOneAttribute <em>One
 * Attribute</em>}</li>
 * <li>{@link testmodel.impl.ReferenceTestContainerImpl#getManyAttributes <em>
 * Many Attributes</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
 */
public class ReferenceTestContainerImpl extends EObjectImpl implements
		ReferenceTestContainer {
	/**
	 * The cached value of the '{@link #getContainments() <em>Containments</em>}
	...
	/**
	 * The cached value of the '{@link #getReferenceToOne()
	...
	/**
	 * The cached value of the '{@link #getReferenceToMany()
	 * <em>Reference To Many</em>}' reference list. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getContainment() <em>Containment</em>}'
	...
	/**
	 * The default value of the '{@link #isOneAttribute()
	...
	/**
	 * The cached value of the '{@link #isOneAttribute() <em>One Attribute</em>}
	...
	/**
	 * The cached value of the '{@link #getManyAttributes()
	 * <em>Many Attributes</em>}' attribute list. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	public EList<ReferenceTarget> getContainments() {
		if (containments == null) {
			containments = new EObjectContainmentEList<ReferenceTarget>(
					ReferenceTarget.class, this,
					TestmodelPackage.REFERENCE_TEST_CONTAINER__CONTAINMENTS);
		}
		return containments;
	}
			...
			if (referenceToOne != oldReferenceToOne) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							TestmodelPackage.REFERENCE_TEST_CONTAINER__REFERENCE_TO_ONE,
							oldReferenceToOne, referenceToOne));
			}
		}
	...
	public EList<ReferenceTarget> getReferenceToMany() {
		if (referenceToMany == null) {
			referenceToMany = new EObjectResolvingEList<ReferenceTarget>(
					ReferenceTarget.class,
					this,
					TestmodelPackage.REFERENCE_TEST_CONTAINER__REFERENCE_TO_MANY);
		}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TestmodelPackage.REFERENCE_TEST_CONTAINER__NAME, oldName,
					name));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetContainment(
			ReferenceTarget newContainment, NotificationChain msgs) {
		ReferenceTarget oldContainment = containment;
		containment = newContainment;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					TestmodelPackage.REFERENCE_TEST_CONTAINER__CONTAINMENT,
					oldContainment, newContainment);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setContainment(ReferenceTarget newContainment) {
		if (newContainment != containment) {
			...
			if (containment != null)
				msgs = ((InternalEObject) containment)
						.eInverseRemove(
								this,
			...
			if (newContainment != null)
				msgs = ((InternalEObject) newContainment)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- TestmodelPackage.REFERENCE_TEST_CONTAINER__CONTAINMENT,
	...
	public void setOneAttribute(boolean newOneAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TestmodelPackage.REFERENCE_TEST_CONTAINER__ONE_ATTRIBUTE,
					oldOneAttribute, oneAttribute));
	}
	...
	public EList<Boolean> getManyAttributes() {
		if (manyAttributes == null) {
			manyAttributes = new EDataTypeUniqueEList<Boolean>(Boolean.class,
					this,
					TestmodelPackage.REFERENCE_TEST_CONTAINER__MANY_ATTRIBUTES);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case TestmodelPackage.REFERENCE_TEST_CONTAINER__CONTAINMENTS:
			return ((InternalEList<?>) getContainments()).basicRemove(otherEnd,
					msgs);
	...
	public void eSet(int featureID, Object newValue) {
		...
		case TestmodelPackage.REFERENCE_TEST_CONTAINER__CONTAINMENTS:
			...
			getContainments().addAll(
					(Collection<? extends ReferenceTarget>) newValue);
			return;
		case TestmodelPackage.REFERENCE_TEST_CONTAINER__REFERENCE_TO_ONE:
