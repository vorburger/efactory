 ...
 * </copyright>
 *
 * $Id: ChildImpl.java 82 2009-11-16 05:39:21Z sebastian.benz $
 */
 ...
 * <ul>
 * <li>{@link testmodel.impl.ChildImpl#getReferenceList <em>Reference List</em>}
 * </li>
 * </ul>
 * </p>
 * 
...
public class ChildImpl extends EObjectImpl implements Child {
	...
	public EList<SingleRequired> getReferenceList() {
		if (referenceList == null) {
			referenceList = new EObjectResolvingEList<SingleRequired>(
					SingleRequired.class, this,
					TestmodelPackage.CHILD__REFERENCE_LIST);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case TestmodelPackage.CHILD__REFERENCE_LIST:
			...
			getReferenceList().addAll(
					(Collection<? extends SingleRequired>) newValue);
			return;
		}
