...
public interface TestmodelFactory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>Test Model</em>'. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Child</em>'. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Custom Name</em>'. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>No Name</em>'. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
