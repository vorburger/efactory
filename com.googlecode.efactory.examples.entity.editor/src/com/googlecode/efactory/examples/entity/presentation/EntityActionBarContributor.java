 ...
 * </copyright>
 *
 * $Id: EntityActionBarContributor.java 82 2009-11-16 05:39:21Z sebastian.benz $
 */
 ...
 * @generated
 */
public class EntityActionBarContributor extends
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				EntityEditorPlugin.INSTANCE.getString("_UI_EntityEditor_menu"),
				"com.googlecode.efactory.examples.entityMenuID");
		...
		//
		createChildMenuManager = new MenuManager(EntityEditorPlugin.INSTANCE
				.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(EntityEditorPlugin.INSTANCE
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(EntityEditorPlugin.INSTANCE
				.getString("_UI_CreateChild_menu_item"));
