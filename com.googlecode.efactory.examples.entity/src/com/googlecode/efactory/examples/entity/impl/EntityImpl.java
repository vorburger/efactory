 ...
 * </copyright>
 *
 * $Id: EntityImpl.java 82 2009-11-16 05:39:21Z sebastian.benz $
 */
 ...
 * <ul>
 * <li>
 * {@link com.googlecode.efactory.examples.entity.impl.EntityImpl#getExtends
 * <em>Extends</em>}</li>
 * <li>
 * {@link com.googlecode.efactory.examples.entity.impl.EntityImpl#getProperties
 * <em>Properties</em>}</li>
 * </ul>
 * </p>
 * 
...
public class EntityImpl extends TypeImpl implements Entity {
			...
			if (extends_ != oldExtends) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							EntityPackage.ENTITY__EXTENDS, oldExtends, extends_));
			}
		}
		return extends_;
	}
	...
	public EList<Property> getProperties() {
		if (properties == null) {
			properties = new EObjectContainmentEList<Property>(Property.class,
					this, EntityPackage.ENTITY__PROPERTIES);
		}
		return properties;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case EntityPackage.ENTITY__EXTENDS:
			if (resolve)
				return getExtends();
