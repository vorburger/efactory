 ...
 * </copyright>
 *
 * $Id: PropertyItemProvider.java 82 2009-11-16 05:39:21Z sebastian.benz $
 */
 ...
 * {@link com.googlecode.efactory.examples.entity.Property} object. <!--
...
public class PropertyItemProvider extends ItemProviderAdapter implements
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				EntityPackage.Literals.PROPERTY__NAME, true, false, false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Property_type_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Property_type_feature", "_UI_Property_type"),
				EntityPackage.Literals.PROPERTY__TYPE, true, false, true, null,
				null, null));
	}
	...
	protected void addManyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Property_many_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Property_many_feature", "_UI_Property_type"),
				EntityPackage.Literals.PROPERTY__MANY, true, false, false,
